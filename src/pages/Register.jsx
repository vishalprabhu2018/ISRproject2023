...
const Register = () => {
  ...
  const handleSubmit = e => {
    ...
    // Name validation
    if (name.length > 40) {
      setNameError("Name and surname should not be longer than 40 characters.");
      isValid = false;
    }
    ...
    if (!passwordRegex.test(password)) {
      setPasswordError(
        "Password must be at least 8 characters, one capital letter, one lowercase"
      );
      isValid = false;
    }
      ...
      <div className="flex justify-center items-center py-5">
        <Card>
          ...
          >
            ...
            >
              {status === "loading" ? "In progress..." : "Register"}
            </button>
          </form>
        </Card>
      </div>
