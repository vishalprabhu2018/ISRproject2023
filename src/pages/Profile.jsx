...
const Profile = () => {
  ...
  const handleSelect = e => {
    ...
    if (selected && types.includes(selected.type)) {
      ...
      setError("Select an image of the .png, .jpeg, or .jpg format");
      reset();
    }
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-[65rem] px-5 sm:px-[8%]">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-3xl my-5 font-semibold">Personal information</h1>
          <div className="border-2 border-solid rounded-md">
            <p className="text-lg p-3 border-b-2">Profile picture</p>
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-4">
            <div className="border-2 border-solid rounded-md w-full">
              ...
              <div className="flex flex-col gap-3 p-3">
                <p>Name and surname: {userData?.displayName}</p>
